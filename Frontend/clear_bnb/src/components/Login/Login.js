...
export default function Login() {
	...
	const toggleAction = (event, type = '') => {
		...
		console.log(type)
		!type ? setRegisterMode((prevState) => !prevState) : submitHandler(type, event)
	}
				...
				<div className='login-form'>
					<form className='form-group' onSubmit={submitHandler}>
						...
						<div className='login-buttons'>
							<button
								type='submit'
								onClick={(event) => toggleAction(event, registerMode ? '' : 'login-user')}>
								Login
							</button>
							<button
								type='submit'
							...
							<button
								type='submit'
								onClick={(event) => toggleAction(event, registerMode ? 'register-user' : '')}>
								Register
							</button>
						</div>
					</form>
